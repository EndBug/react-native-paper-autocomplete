...
function Autocomplete(_a) {
    var array = _a.array, initialValue = _a.initialValue, label = _a.label, onValueSelected = _a.onValueSelected, onError = _a.onError;
    var _b = react_1.useState(initialValue || ''), text = _b[0], setText = _b[1];
    var _c = react_1.useState(initialValue || ''), selected = _c[0], setSelected = _c[1];
    ...
    return (react_1["default"].createElement(react_native_1.View, null,
        react_1["default"].createElement(react_native_paper_1.TextInput, { label: label, onFocus: onFocus, onKeyPress: onFocus, value: text, error: error, onChangeText: setText }),
        error && showList()));
}
